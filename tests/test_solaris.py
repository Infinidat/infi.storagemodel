...
STORAGEMODEL_361_FCINFO_OUTPUT = """OS Device Name: /devices/scsi_vhci/array-controller@g6742b0f0000004aa0000000000000000
    HBA Port WWN: 21000024ff58d9f5
        Remote Port WWN: 5742b0f00004aa11
        Remote Port WWN: 5742b0f00004aa31
        Remote Port WWN: 5742b0f00004aa21
    HBA Port WWN: 21000024ff58da4d
        Remote Port WWN: 5742b0f00004aa15
        Remote Port WWN: 5742b0f00004aa35
        Remote Port WWN: 5742b0f00004aa25
    LUN: 0
    Vendor: NFINIDAT
    Product: InfiniBox
    Device Type: Storage Array Controller Device
OS Device Name: /dev/rdsk/c0t6742B0F0000004AA0000000000001B1Bd0s2
    HBA Port WWN: 21000024ff58d9f5
        Remote Port WWN: 5742b0f00004aa11
        Remote Port WWN: 5742b0f00004aa31
        Remote Port WWN: 5742b0f00004aa21
...
FCINFO_BASIC_OUTPUT = """OS Device Name: /devices/scsi_vhci/array-controller@g6742b0f0000075540000000000000000
    HBA Port WWN: 10000000c9911877
        Remote Port WWN: 5742b0f000755411
    LUN: 0
    Vendor: NFINIDAT
    Product: InfiniBox
    Device Type: Storage Array Controller Device
...
class SolarisFcinfoTest(TestCase):
    @contextmanager
    def fcinfo_context(self, output):
        def side_effect(cmd):
            return output
        with patch("infi.storagemodel.solaris.fcinfo.execute_command_safe", side_effect=side_effect):
            yield

    def test_fcinfo_get_lun(self):
        from infi.storagemodel.solaris.fcinfo import get_path_lun
        with self.fcinfo_context(FCINFO_BASIC_OUTPUT):
            self.assertEquals(get_path_lun("array-controller@g6742b0f0000075540000000000000000", "10000000c9911877", "5742b0f000755411"), 0)

    def test_storagemodel_361(self):
        from infi.storagemodel.solaris.fcinfo import get_path_lun
        with self.fcinfo_context(STORAGEMODEL_361_FCINFO_OUTPUT):
            self.assertEquals(get_path_lun("array-controller@g6742b0f0000004aa0000000000000000", "21000024ff58d9f5", "5742b0f00004aa11"), 0)
            self.assertEquals(get_path_lun("array-controller@g6742b0f0000004aa0000000000000000", "21000024ff58d9f5", "5742b0f00004aa31"), 0)
            self.assertEquals(get_path_lun("array-controller@g6742b0f0000004aa0000000000000000", "21000024ff58d9f5", "5742b0f00004aa21"), 0)
            self.assertEquals(get_path_lun("array-controller@g6742b0f0000004aa0000000000000000", "21000024ff58da4d", "5742b0f00004aa15"), 0)
            self.assertEquals(get_path_lun("array-controller@g6742b0f0000004aa0000000000000000", "21000024ff58da4d", "5742b0f00004aa35"), 0)
            self.assertEquals(get_path_lun("array-controller@g6742b0f0000004aa0000000000000000", "21000024ff58da4d", "5742b0f00004aa25"), 0)
            self.assertEquals(get_path_lun("c0t6742B0F0000004AA0000000000001B1Bd0s2", "21000024ff58d9f5", "5742b0f00004aa11"), 1)
            self.assertEquals(get_path_lun("c0t6742B0F0000004AA0000000000001B1Bd0s2", "21000024ff58d9f5", "5742b0f00004aa31"), 1)
            self.assertEquals(get_path_lun("c0t6742B0F0000004AA0000000000001B1Bd0s2", "21000024ff58d9f5", "5742b0f00004aa21"), 1)
            self.assertEquals(get_path_lun("c0t6742B0F0000004AA0000000000001B1Bd0s2", "21000024ff58da4d", "5742b0f00004aa15"), 1)
            self.assertEquals(get_path_lun("c0t6742B0F0000004AA0000000000001B1Bd0s2", "21000024ff58da4d", "5742b0f00004aa35"), 1)
            self.assertEquals(get_path_lun("c0t6742B0F0000004AA0000000000001B1Bd0s2", "21000024ff58da4d", "5742b0f00004aa25"), 1)