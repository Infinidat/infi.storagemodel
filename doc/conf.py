# -*- coding: utf-8 -*-
#
# infi.storagemodel documentation build configuration file, created by
# sphinx-quickstart on Wed Aug  3 19:05:48 2011.
#
...
run("easy_install zc.buildout==1.6.3")
run("python bootstrap.py -d -v 1.6.3")
run("bin/buildout -s buildout:develop= install isolated-python")
run("parts/python/bin/python bootstrap.py -d -v 1.6.3")
run("bin/buildout -s buildout:develop= install setup.py __version__.py")
run("bin/buildout -s install development-scripts")
os.chdir(curdir)
